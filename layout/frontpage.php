	...
	<section id="header-wrap">
		<header role="banner" class="navbar navbar-fixed-top moodle-has-zindex">
			<nav role="navigation" class="navbar-inner">
				<div id="brand">
					<div id="logo" >
						<a href="<?php echo $CFG->wwwroot;?>"><img src="<?php echo $OUTPUT->pix_url('logo', 'theme'); ?>" alt="Peace Corps Logo" />Peace Corps | <span>University</span></a>
					</div>
				</div>
	...
	<section id="custom-blocks">
		<div class="row-fluid">
			<div class="alert-box">
				...
				<?php echo $OUTPUT->blocks('action-one', ''); ?>
			</div>
		</div>
		<div class="row-fluid">
			<div class="action-blocks">
				<?php echo $OUTPUT->blocks('frontpage-one', 'span4'); ?>
				<?php echo $OUTPUT->blocks('frontpage-two', 'span4'); ?>
				<?php echo $OUTPUT->blocks('frontpage-three', 'span4'); ?>
			</div>
		</div>
	</section>
